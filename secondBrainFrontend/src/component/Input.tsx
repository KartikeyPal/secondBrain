  ...
  return (
    <div className="relative min-w-[200px] w-[75%] group">
      <input 
        ...
        className="absolute pt-2 cursor-text bg-slate-50 px-1 left-2.5 top-2.5 text-slate-400 text-sm transition-all transform origin-left
      peer-hover:-top-2 peer-hover:left-2.5 peer-hover:text-xs peer-hover:text-slate-400 peer-hover:scale-90
